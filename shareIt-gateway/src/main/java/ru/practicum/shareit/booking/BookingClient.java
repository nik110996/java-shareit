...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllByState(long userId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findAllByItemOwner(long userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
    ...
    public ResponseEntity<Object> create(long userId, BookingDtoInitial requestDto) {
